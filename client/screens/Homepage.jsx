            ...
            <View style={styles.header}>
                ...
                <View style={styles.headerTextCon}>
                    ...
                    <Text style={styles.headerTextWelcome}>
                        Welcome to{"  "}
                        <Text style={styles.headerTextWelcome2}>
                            Hemo Insight
                        </Text>{" "}
                    </Text>
                </View>
                    ...
                    {loggedInLoading ? (
                        ...
                        <>
                            ...
                            {loggedInData?.loggedIn.status == "Premium" ? (
                                <View
                                    style={
                                        styles.profileCardTopSectionButtonCon
                                    }
                                >
                                    {/* onSite */}
                        ...
                        <View style={styles.bannerCard}>
                            ...
                            <View style={styles.bannerCardBody}>
                                ...
                                <Text style={styles.bannerCardBodyContent}>
                                    Supercharge Your Wellness Journey! Subscribe
                                    Now for a 10% Discount on All Services.
                                </Text>
                            </View>
                        </View>
                        <View>
                            ...
                            >
                                ...
                                >
                                    Don't Miss Out – Act Now for a Healthier,
                                    Happier You!
                                </Text>
                                <View
                                    style={{
                                ...
                                >
                                    ...
                                    >
                                        <View style={{ margin: 12, gap: 10 }}>
                                            ...
                                            <Text
                                                style={
                                                    styles.bannerCardBodyTitle2
                                                }
                                            >
                                                Enjoy all year 10% discount from
