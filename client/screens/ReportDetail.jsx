            ...
            <View style={styles.con}>
                ...
                {ReportByIdLoading ? (
                    ...
                    <View style={styles.card}>
                        ...
                        {/* status */}
                        <Text
                            style={getStatusColor(ReportById?.report?.status)}
                        >
                        ...
                        <View style={styles.cardBorder}>
                            {ReportById?.report?.userOwner && (
                                <View style={styles.profileCardTopSection}>
                                    ...
                                    <Image
                                        style={
                                            styles.profileCardTopSectionImage
                                        }
                                        source={{
                                    ...
                                    <View
                                        style={
                                            styles.profileCardTopSectionTextCon
                                        }
                                    >
                                        {/* username */}
                                        <Text
                        ...
                        <Pressable
                            ...
                            onPress={() => {
                                let pay = subTotal;
                                if (
                                    ReportById?.report?.userOwner?.status !==
                                    "Regular"
                                ) {
                                    pay *= 0.9;
                                }
